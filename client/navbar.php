...
<body class="w-full overflow-x-hidden">
    <nav class="relative px-4 py-4 flex justify-between items-center bg-gray-100 w-full overflow-x-hidden m-0">
        ...
        <ul
            ...
            <li><a class="text-sm text-gray-400 active:text-gray-500" href="#">Home</a></li>
            <li><a class="text-sm  text-ray-g400 active:text-green-500 " href="#categories">Categories</a></li>
            <li><a class="text-sm text-gray-400 active:text-gray-500" href="#blogs">Blogs</a></li>
            <li><a class="text-sm text-gray-400 active:text-gray-500" href="#contact">Contact</a></li>
            <li><a class="text-sm text-gray-400 active:text-gray-500" href="#faq">FAQ</a></li>
